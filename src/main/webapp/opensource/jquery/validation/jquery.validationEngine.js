...
(function($) {
	...
	var methods = {
		...
		_validateField : function(field, options, skipAjaxValidation) {
			...
			//hhupdate
			if ((field.is(":hidden") && !options.prettySelect
					|| field.parent().is(":hidden")) && 'ckeditor' != field.attr('xtype'))
				return false;
...
//				return false;
		...
		_required : function(field, rules, i, options) {
			var type = field.prop("type") || field.attr("type");
			switch (type) {
				case "ckeditor" :
					if(!$.trim(field.getValue())){
		...
		_closePrompt : function(field) {
			...
			}else if(field.attr('xtype')=='ckeditor'){
				field = $(field.children()[0]);
			}else{
